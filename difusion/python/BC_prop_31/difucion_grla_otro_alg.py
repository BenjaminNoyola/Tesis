...
norma1=1.
norma2=2.
#for kk in range(pasosos):
while (abs((norma2-norma1)/norma2)>10**(-8)):
 
	norma1=linalg.norm(T)
	#(1)...Cálculo de las condiciones de frontera tal y como se indica en la ref 31
	for i in range(lattice_y):
	...
	T = f.sum(axis=2)
	norma2=linalg.norm(T)

print T
savetxt('Temperatura_gral_otro_alg.txt', T,fmt='%.4f')
